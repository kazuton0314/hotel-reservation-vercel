...
import {
  ReservationMailHistorySuspense,
  ReservationMailSuspense,
  ReservationOverlapSuspense,
  ReservationRoomsCompanionsSuspense,
} from "@/components/reservations/ReservationDetailSecondary";
...
async function DetailContent({
  ...
  return (
    <>
      ...
      <ReservationMailSuspense reservationId={id} reservation={r} />
      <ReservationMailHistorySuspense reservationId={id} />
      <ReservationRoomsCompanionsSuspense
        reservationId={id}
        reservation={r}
      />
